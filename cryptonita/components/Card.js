        ...
        <div id="Card" className="card mt-4">
            <div className="card-body">
                ...
                <input id="Fondo-textos" type="text" className="form-control mt-4" placeholder="Ingrese su número de cuenta"
                    required defaultValue={NumeroCuenta} onChange={NumeroCuentaOnChange} />
    ...
    return <aside >
        <div id="Card" className="card mt-4">
            <div className="card-body">
                ...
                <input required id="Fondo-textos" type="text" className="form-control mt-4" defaultValue={NumeroBilletera} onChange={NumeroBilleteraOnChange} />
                <h5 id="Titulos" className="card-subtitle mb-2 mt-4">Número de operación: </h5>
                <div id="Fondo-textos" className="card">
                    <div className="card-body">
                        <h6 >{props.IdTransaccion}</h6>
    ...
    return <aside >
        <div id="Card" className="card mt-4">
            <div className="card-body">
                ...
                <input required id="Fondo-textos" type="text" className="form-control mt-4" defaultValue={NumeroTransaccion} onChange={NumeroTransaccionOnChange} />
