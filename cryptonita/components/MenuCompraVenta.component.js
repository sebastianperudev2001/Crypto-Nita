const MenuCompraVenta = (props) => {
    ...
    return <div>
            ...
            <div className="row">
                ...
                <div className="col-md">
                    <div class="d-grid gap-5">
                        <button class="btn btn-primary" type="button" onClick={comprarOC}>
                            <p className="fs-1">Compra</p>
                            Cambio:{" "}{props.btcpen}
                        </button>
                        <button class="btn btn-primary" type="button" onClick={venderOC}>
        ...
        <div className="d-grid justify-content-end">
                <button className="btn btn-danger" onClick={regresarOC}>Regresar</button>
        </div>
    </div>
}
